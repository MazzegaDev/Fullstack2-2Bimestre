...
export default class ImovelController {
    ...
    async cadastrar(req, res) {
        ...
        let imovel = new Imovel(0, descricao, endereco, cep, bairro, cidade, valor, disponivel);
            ...
            if(await this.#repoImovel.cadastrar(imovel)) {
                ...
                if(req.files.length > 0) {
                    for(let imagem of req.files) {
                        let imagemEntity = new ImagemImovel();
    ...
    async alterar(req, res) {
        ...
        let imovel = new Imovel(id, descricao, endereco, cep, bairro, cidade, valor, disponivel);
        if(imovel.validar()) {
