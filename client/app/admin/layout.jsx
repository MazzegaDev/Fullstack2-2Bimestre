...
//Aqui estamos importando uma fonte do proprio next
import {Nunito} from "next/font/google";
const nunito = Nunito({subsets: ['latin']})

//Esse é o layout de todas as paginas de adm
export default function AdminLayout({children}) {

    return (
        <div>
            
            <div id="wrapper" className={nunito.className}>{/*Aqui estamos usando nossa fonte que importamos*/}
                ...
                <div id="content-wrapper" className="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        <div style={{minHeight: 800}}>
                            {/*Aqui é chamada as pages de adm */}
                            {children}
                        </div>
