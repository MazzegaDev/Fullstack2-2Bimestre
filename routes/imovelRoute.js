...
router.post("/", auth.validarToken, upload.array("imagens", 5), (req, res) => {
    /* #swagger.security = [{
        "bearerAuth": []
    }] */
    // #swagger.tags = ['Imóvel']
...
router.put("/", auth.validarToken, upload.array("imagens", 5), (req, res) => {
    /* #swagger.security = [{
        "bearerAuth": []
    }] */
    // #swagger.tags = ['Imóvel']
...
router.delete("/imovel/:id", auth.validarToken, (req, res) => {
    /* #swagger.security = [{
        "bearerAuth": []
    }] */
    // #swagger.tags = ['Imóvel']
